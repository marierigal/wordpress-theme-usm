 ...
 * @version  1.0.0
 */
function usm_parent_theme_style() {
	if ( ! current_theme_supports( 'child-theme-stylesheet' ) ) {
		wp_enqueue_style( 'usm-parent-style', get_template_directory_uri() . '/style.css' );
		wp_enqueue_style( 'usm-child-style', get_stylesheet_uri() );
	}
}
add_action( 'wp_enqueue_scripts', 'usm_parent_theme_style', 1000 );
 ...
 * @version  1.0.0
 */
function usm_parent_theme_options() {
...
add_action( 'after_switch_theme', 'usm_parent_theme_options' );
